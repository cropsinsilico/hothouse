...
To install hothouse, run this command in your terminal:

.. code-block:: console

    $ pip install hothouse

This is the preferred method to install hothouse, as it will always install the most recent stable release.
...
The sources for hothouse can be downloaded from the `Github repo`_.
